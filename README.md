...
| [Анализ соотношения транзакций и upgrade](Analysis_of_FTT_vs_FTU) | Выяснить как соотносятся между собой:
FTT и sign up, FTT и FTU, FTU и sign up | *pandas, numpy, matplotlib, seaborn* |
